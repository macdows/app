  ...
  return (
    <>
      ...
      <div className="flex">
        ...
        {accountInfo && (
          <>
            <LinkButton className="mr-2" label={c('Action').t`Open Blog`} link={accountInfo.author_url} />
            <LinkButton className="mr-2" label={c('Action').t`Settings`} link={accountInfo.settings_url} />
          </>
        )}
      </div>
